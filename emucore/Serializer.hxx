...
/**
  ...
  written as characters prepended by the length of the std::string.
  ...
  The new version uses a std::stringstream (not a file stream)
*/
class Serializer
{
  public:
    ...
    */
    ...
    /**
      Writes a std::string to the current output stream.

      @param str The std::string to write to the output stream.
    */
