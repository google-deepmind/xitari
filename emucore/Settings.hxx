...
class Settings
{
  ...
  public:
    ...
    */
    ...
    /**
      ...
      @return Name of the ROM to load, otherwise empty std::string
    */
    ...
    */
    ...
    /**
      ...
      @param key The key of the setting to lookup
      @return The std::string value of the setting
    */
  ...
  private:
    ...
    // Trim leading and following whitespace from a std::string
