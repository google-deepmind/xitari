...
M6532::M6532(const Console& console)
    : myConsole(console)
{
  // Zero out the RAM for reproducibility
...
uInt8 M6532::peek(uInt16 addr)
{
  switch(addr & 0x07)
  {
    ...
    {    
      ...
      std::cerr << "BAD M6532 Peek: " << hex << addr << std::endl;
#endif
      return 0;
    }
  }
...
//        myDDRB = value;
  ...
  {
#ifdef DEBUG_ACCESSES
    std::cerr << "M6532 Poke (Write Edge Detect): "
  ...
  {
#ifdef DEBUG_ACCESSES
    std::cerr << "BAD M6532 Poke: " << hex << addr << std::endl;
#endif
  }
}
