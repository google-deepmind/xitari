...
class Properties
{
  ...
  public:
    /**
      ...
      not exist then the empty std::string is returned.
  ...
  private:
    ...
    */
    ...
    /**
      Read the next quoted std::string from the specified input stream
      and returns it.

      @param in The input stream to use
      @return The std::string inside the quotes
    */ 
    static std::string readQuotedString(std::istream& in);
     
    /**
      Write the specified std::string to the given output stream as a 
      quoted std::string.

      @param out The output stream to use
      @param s The std::string to output
    */ 
    ...
    /**
      ...
      @param name  The PropertyType key associated with the given std::string
    */ 
  ...
  private:
    ...
    // The text std::strings associated with each property type
