 ...
 ******************************************************************** */
void ExportScreen::save_png(const IntMatrix* screen_matrix, const std::string& filename) {
...
void ExportScreen::export_any_matrix (const IntMatrix* pm_matrix,
    ...
    uInt8* compmem = (uInt8*) NULL;
    std::ofstream out;
    int height = static_cast<int>(pm_matrix->size());
    int width = static_cast<int>((*pm_matrix)[0].size());
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
void ExportScreen::writePNGChunk(std::ofstream& out, const char* type, uInt8* data,
                                int size) const {
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
void ExportScreen::writePNGText(std::ofstream& out,
                                const std::string& key,
                                const std::string& text) const
{
    int length = static_cast<int>(key.length() + 1 + text.length() + 1);
